...
def start(message):
	...
	if f == SUDO:
		...
		me = types.InlineKeyboardButton(text="𝑩𝑨𝑺𝑯𝑨𝑹𖠇",url="https://t.me/U_U_U")
		he = types.InlineKeyboardButton(text="حيدر",url="https://t.me/YHYYY")
		de = types.InlineKeyboardButton(text="دراكون",url="https://t.me/s_l_3")
		ch = types.InlineKeyboardButton(text="▶ قناة البوت ◀",url="https://t.me/x_x_T")
		rr.add(me,he,de)
		rr.add(ch)
